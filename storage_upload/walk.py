...
parser.add_argument("--img-filename", default=''''\\.\PHYSICALDRIVE3''')
parser.add_argument("--img-size", type=int, default=1 * 1024 * 1024)
parser.add_argument("--block-size", type=int, default=4096)
parser.add_argument("--read-size", type=int, default=16)
parser.add_argument("--prog-size", type=int, default=16)
